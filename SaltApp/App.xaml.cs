...
//        }
        ...
        private void CheckLocalization()
        {
            ...
            if(currentLanguage.Contains("en"))
                LocalizationManager.Instance.InitializeObjects(Languages.English);
            else if (currentLanguage.Contains("es"))
                LocalizationManager.Instance.InitializeObjects(Languages.Spanish);
            else if (currentLanguage.Contains("pt"))
                LocalizationManager.Instance.InitializeObjects(Languages.Portuguese);
        }
